...
-- ---------------------------------------------------------------------------
insert into obligations (id, organization_id, ownership_entity_id, property_id, vendor_id, name, description, category, amount, frequency, interval_months, due_day, next_due_date, status, notes) values
  ('71000000-0000-4000-8000-000000000027', '11000000-0000-4000-8000-000000000001', '21000000-0000-4000-8000-000000000006', '31000000-0000-4000-8000-000000000003', '61000000-0000-4000-8000-000000000002', '[DEMO] Electric — 309 Hancock', 'Monthly electric service (dummy)', 'utility', 180.00, 'monthly', 1, 20, '2026-08-20', 'open', null),
  ('71000000-0000-4000-8000-000000000028', '11000000-0000-4000-8000-000000000001', '21000000-0000-4000-8000-000000000006', '31000000-0000-4000-8000-000000000006', '61000000-0000-4000-8000-000000000003', '[DEMO] Water & Sewer — Motor Co', 'Monthly water/sewer (dummy)', 'utility', 95.00, 'monthly', 1, 12, '2026-08-12', 'open', null),
  ('71000000-0000-4000-8000-000000000029', '11000000-0000-4000-8000-000000000001', '21000000-0000-4000-8000-000000000006', '31000000-0000-4000-8000-000000000002', '61000000-0000-4000-8000-000000000004', '[DEMO] HVAC Maintenance — Tacos2', 'Monthly HVAC maintenance (dummy)', 'maintenance', 120.00, 'monthly', 1, 25, '2026-08-25', 'open', null),
  ('71000000-0000-4000-8000-000000000030', '11000000-0000-4000-8000-000000000001', '21000000-0000-4000-8000-000000000006', '31000000-0000-4000-8000-000000000004', '61000000-0000-4000-8000-000000000001', '[DEMO] Liability Insurance — Teachable Moments', 'Annual liability policy (dummy)', 'insurance', 2400.00, 'annual', null, 15, '2026-10-15', 'open', null)
on conflict (id) do nothing;
