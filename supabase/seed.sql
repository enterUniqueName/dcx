...
-- ---------------------------------------------------------------------------
insert into loans (id, organization_id, ownership_entity_id, property_id, lender, loan_number, nickname, monthly_payment, payment_frequency, payment_url, status) values
  ('41000000-0000-4000-8000-000000000001', '11000000-0000-4000-8000-000000000001', '21000000-0000-4000-8000-000000000006', '31000000-0000-4000-8000-000000000004', 'Freedom First', '0007406434220002', 'Bus. Term R/E 360 | Thomson #2', 459.9, 'monthly', 'https://my.freedomfirst.com/login', 'active'),
  ('41000000-0000-4000-8000-000000000002', '11000000-0000-4000-8000-000000000001', '21000000-0000-4000-8000-000000000006', '31000000-0000-4000-8000-000000000012', 'Pinnacle', '90865277', '2597/99 Fort', 2879.17, 'monthly', 'https://www.pnfp.com', 'active'),
  ('41000000-0000-4000-8000-000000000003', '11000000-0000-4000-8000-000000000001', '21000000-0000-4000-8000-000000000006', '31000000-0000-4000-8000-000000000003', 'Pinnacle', '90870210', '309 Hancock', 1710.94, 'monthly', 'https://www.pnfp.com', 'active'),
  ('41000000-0000-4000-8000-000000000004', '11000000-0000-4000-8000-000000000001', '21000000-0000-4000-8000-000000000006', '31000000-0000-4000-8000-000000000005', 'Pinnacle', '90870211', '313 Hancock', 1664.06, 'monthly', 'https://www.pnfp.com', 'active'),
  ('41000000-0000-4000-8000-000000000005', '11000000-0000-4000-8000-000000000001', '21000000-0000-4000-8000-000000000007', null, 'Pinnacle', '20231236720', 'LOC DC', 20959.62, 'monthly', 'https://www.pnfp.com', 'active'),
  ('41000000-0000-4000-8000-000000000006', '11000000-0000-4000-8000-000000000001', '21000000-0000-4000-8000-000000000001', null, 'Pinnacle', '90850703', 'LOC JenCal', 1376.33, 'monthly', 'https://www.pnfp.com', 'active'),
  ('41000000-0000-4000-8000-000000000007', '11000000-0000-4000-8000-000000000001', '21000000-0000-4000-8000-000000000006', '31000000-0000-4000-8000-000000000006', 'Pinnacle', '90610425', '305 6th | Motor Co', 12345, 'monthly', 'https://www.pnfp.com', 'active'),
  ('41000000-0000-4000-8000-000000000008', '11000000-0000-4000-8000-000000000001', '21000000-0000-4000-8000-000000000006', null, 'Pinnacle', '90840959', 'LOC PLB', 1700.47, 'monthly', 'https://www.pnfp.com', 'active'),
  ('41000000-0000-4000-8000-000000000009', '11000000-0000-4000-8000-000000000001', '21000000-0000-4000-8000-000000000003', '31000000-0000-4000-8000-000000000007', 'Freedom First', '0007406742200001', 'LOC 901 5th', 6342.04, 'monthly', 'https://my.freedomfirst.com/login', 'active'),
  ('41000000-0000-4000-8000-000000000010', '11000000-0000-4000-8000-000000000001', '21000000-0000-4000-8000-000000000001', null, 'Freedom First', '0007406912240001', 'LOC R/E 360', 5022.57, 'monthly', 'https://my.freedomfirst.com/login', 'active'),
  ('41000000-0000-4000-8000-000000000011', '11000000-0000-4000-8000-000000000001', '21000000-0000-4000-8000-000000000006', '31000000-0000-4000-8000-000000000009', 'Freedom First', '0007406283140001', 'Business Term 2300 Bedford', 1224.29, 'monthly', 'https://my.freedomfirst.com/login', 'active'),
  ('41000000-0000-4000-8000-000000000012', '11000000-0000-4000-8000-000000000001', '21000000-0000-4000-8000-000000000006', null, 'Freedom First', '0007406434220001', '1915 Thomson #1', 3236.68, 'monthly', 'https://my.freedomfirst.com/login', 'active'),
  ('41000000-0000-4000-8000-000000000013', '11000000-0000-4000-8000-000000000001', '21000000-0000-4000-8000-000000000001', '31000000-0000-4000-8000-000000000008', 'Freedom First', '0007406492990001', 'LOC 58 9th', 6091.41, 'monthly', 'https://my.freedomfirst.com/login', 'active')
on conflict (id) do nothing;
...
-- ---------------------------------------------------------------------------
insert into vendors (id, organization_id, name, category, email, phone, website, active) values
  ('61000000-0000-4000-8000-000000000001', '11000000-0000-4000-8000-000000000001', '[DEMO] Apex Commercial Insurance', 'insurance', 'billing@demo-apex.example', '555-0101', null, true),
  ('61000000-0000-4000-8000-000000000002', '11000000-0000-4000-8000-000000000001', '[DEMO] Rockland Power & Light', 'electric', 'accounts@demo-rockland.example', '555-0102', 'https://www.appalachianpower.com/account/bills', true),
  ('61000000-0000-4000-8000-000000000003', '11000000-0000-4000-8000-000000000001', '[DEMO] City Water & Sewer', 'water', 'water@demo-city.example', '555-0103', 'https://webapps.lynchburgva.gov/citylink/AccountLinks', true),
  ('61000000-0000-4000-8000-000000000004', '11000000-0000-4000-8000-000000000001', '[DEMO] Hearthside HVAC', 'maintenance', 'service@demo-hearthside.example', '555-0104', null, true),
  ('61000000-0000-4000-8000-000000000005', '11000000-0000-4000-8000-000000000001', '[DEMO] GreenScape Landscaping', 'maintenance', 'info@demo-greenscape.example', '555-0105', null, true)
on conflict (id) do nothing;
...
-- linked to the tenant as well as the property for visibility. Electric bills
-- are due 29 days after the previous bill (interval_days = 29), not on a
-- fixed day of the month.
insert into obligations (id, organization_id, ownership_entity_id, property_id, vendor_id, tenant_id, name, description, category, amount, frequency, interval_months, due_day, weekday, nth_occurrence, interval_days, next_due_date, status, variable_amount, notes) values
  ('71000000-0000-4000-8000-000000000027', '11000000-0000-4000-8000-000000000001', '21000000-0000-4000-8000-000000000006', '31000000-0000-4000-8000-000000000003', '61000000-0000-4000-8000-000000000002', '51000000-0000-4000-8000-000000000001', '[DEMO] Electric — 309 Hancock', 'Due 29 days after the previous bill (real bills arrive 28-33 days)', 'electric', 180.00, 'monthly', 1, null, null, null, 29, '2026-08-20', 'open', true, null),
  ('71000000-0000-4000-8000-000000000028', '11000000-0000-4000-8000-000000000001', '21000000-0000-4000-8000-000000000006', '31000000-0000-4000-8000-000000000003', '61000000-0000-4000-8000-000000000004', null, '[DEMO] Water & Sewer — Motor Co', 'Monthly water/sewer due the 2nd-to-last Wednesday', 'water', 95.00, 'monthly', 1, null, 3, -2, null, '2026-08-19', 'open', true, null),
  ('71000000-0000-4000-8000-000000000029', '11000000-0000-4000-8000-000000000001', '21000000-0000-4000-8000-000000000006', '31000000-0000-4000-8000-000000000002', '61000000-0000-4000-8000-000000000004', null, '[DEMO] HVAC Maintenance — Tacos2', 'Monthly HVAC maintenance (dummy)', 'maintenance', 120.00, 'monthly', 1, 25, null, null, null, '2026-08-25', 'open', false, null),
  ('71000000-0000-4000-8000-000000000030', '11000000-0000-4000-8000-000000000001', '21000000-0000-4000-8000-000000000006', '31000000-0000-4000-8000-000000000004', '61000000-0000-4000-8000-000000000001', null, '[DEMO] Liability Insurance — Teachable Moments', 'Annual liability policy (dummy)', 'insurance', 2400.00, 'annual', null, 15, null, null, null, '2026-10-15', 'open', false, null)
on conflict (id) do nothing;
